...
contains
  ...
  subroutine sneut5_noderivs(temp, den, abar, zbar, snu)
    ...
    ! declare the pass
    double precision :: temp, den, abar, zbar, snu

    double precision :: dsnudt, dsnuda, dsnudz, dsnudd
  ...
  end subroutine sneut5_noderivs
